...
#                 if i == 1:
#                     column = ['stay_id', 'time', 'sbp', 'dbp', 'map', 'label']
#                 elif i == 2:
#                     column = ['stay_id', 'time', 'hr', 'label']
#                 elif i == 3:
#                     column = ['stay_id', 'time', 'rr', 'label']
#                 elif i == 4:
#                     column = ['stay_id', 'time', 'spo2', 'label']
#                 elif i == 5:
#                     column = ['stay_id', 'time', 'temp', 'label']
...
#
#         result = fill_missing_rows(data_np)
#         column_names = ['stay_id', 'time', 'sbp', 'dbp', 'map', 'label']
