...
#     if type == "blood":
#         df = pd.DataFrame(numpy_array_dropped, columns=['subject_id', 'hadm_id', 'stay_id', 'sbp', 'dbp', 'map', 'time', 'label'])
#         print(df)
#         df_mean = df.groupby(['subject_id', 'hadm_id', 'stay_id', 'time']).mean().reset_index()
#     elif type == "hr":
#         df = pd.DataFrame(numpy_array_dropped, columns=['subject_id', 'hadm_id', 'stay_id', 'hr', 'time', 'label'])
#         df_mean = df.groupby(['subject_id', 'hadm_id', 'stay_id', 'time']).mean().reset_index()
#     elif type == "rr":
#         df = pd.DataFrame(numpy_array_dropped, columns=['subject_id', 'hadm_id', 'stay_id', 'rr', 'time', 'label'])
#         df_mean = df.groupby(['subject_id', 'hadm_id', 'stay_id', 'time']).mean().reset_index()
#     elif type == "spo2":
#         df = pd.DataFrame(numpy_array_dropped, columns=['subject_id', 'hadm_id', 'stay_id', 'spo2', 'time', 'label'])
#         df_mean = df.groupby(['subject_id', 'hadm_id', 'stay_id', 'time']).mean().reset_index()
#     elif type == "temp":
#         df = pd.DataFrame(numpy_array_dropped, columns=['subject_id', 'hadm_id', 'stay_id', 'temp', 'time', 'label'])
#         df_mean = df.groupby(['subject_id', 'hadm_id', 'stay_id', 'time']).mean().reset_index()
#
#     return df_mean
#
